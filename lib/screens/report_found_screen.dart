            ...
            child: Column(
              ...
              children: [
                // Title Input
                  ...
                  label: 'Nama Barang',
                  hint: 'Contoh: Dompet Pria Kulit Hitam',
                ...
                _buildTextField(
                  ...
                  label: 'Detail Lokasi',
                  hint: 'Contoh: Di samping wastafel atau bawah kursi',
                ...
                _buildTextField(
                  ...
                  hint:
                      'Jelaskan ciri-ciri barang, warna, kondisi, apa yang ada di dalamnya, dll',
                    ...
                    if (_formKey.currentState?.validate() ?? false) {
                      if (_selectedDate == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Tanggal ditemukan harus dipilih'),
                          ),
                        );
                        return;
                      }
                      ...
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Barang ditemukan berhasil dilaporkan!',
                            ),
